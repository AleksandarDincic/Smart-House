...
CREATE TABLE `adresa` (
  ...
  PRIMARY KEY (`idKor`),
  CONSTRAINT `FK_adresa_idKor` FOREIGN KEY (`idKor`) REFERENCES `korisnik` (`idKor`) ON DELETE CASCADE
...
INSERT INTO `adresa` VALUES (2,'bulevar kralja aleksandra 214'),(4,'21');
